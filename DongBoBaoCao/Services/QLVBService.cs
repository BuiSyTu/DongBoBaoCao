            ...
            for (var i = 0; i < dataYears.Count; i++)
            {
                ...
                for (var j = 0; j < months.Count; j++)
                {
                    ...
                    for (var k = 0; k < officeCodes.Count; k++)
                    {
                        ...
                        {
                            Code = "DH01010101",
                            value = DH010101.value * (80 + random.Next(-7, 7)) / 100
                        };
                        indicators.Add(DH01010101);
                        ...
                        {
                            Code = "DH01010201",
                            value = DH010102.value * (5 + random.Next(-3, 3)) / 100
                        };
                        indicators.Add(DH01010201);
                        ...
                        {
                            Code = "DH01010202",
                            value = DH010102.value * (20 + random.Next(-2, 2)) / 100
                        };
                        indicators.Add(DH01010202);
                        ...
                        {
                            Code = "DH01010301",
                            value = DH010103.value * (10 + random.Next(-2, 2)) / 100
                        };
                        indicators.Add(DH01010301);
                        ...
                        {
                            Code = "DH01010302",
                            value = DH010103.value * (30 + random.Next(-2, 2)) / 100
                        };
                        indicators.Add(DH01010302);
                        ...
                        {
                            Code = "DH01010303",
                            value = DH010103.value - DH01010301.value - DH01010302.value
                        };
                        indicators.Add(DH01010303);
                        ...
                        {
                            Code = "DH01010401",
                            value = DH010104.value * (30 + random.Next(-4, 4)) / 100
                        };
                        indicators.Add(DH01010401);
                        ...
                        {
                            Code = "DH01010402",
                            value = DH010104.value * (40 + random.Next(-4, 4)) / 100
                        };
                        indicators.Add(DH01010402);

                        var DH01010403 = new Indicator
                        {
                            Code = "DH01010403",
                            value = DH010104.value = DH01010401.value - DH01010402.value
                        };
                        indicators.Add(DH01010403);

                        var DH010105 = new Indicator
                        {
                            Code = "DH010105",
                            value = DH0101.value
                        };
                        indicators.Add(DH010105);

                        var DH01010501 = new Indicator
                        {
                            Code = "DH01010501",
                            value = DH010105.value * (10 + random.Next(-2, 2)) / 100
                        };
                        indicators.Add(DH01010501);

                        var DH01010502 = new Indicator
                        {
                            Code = "DH01010502",
                            value = DH010105.value * (10 + random.Next(-2, 2)) / 100
                        };
                        indicators.Add(DH01010502);

                        var DH010106 = new Indicator
                        {
                            Code = "DH010106",
                            value = DH0101.value * (80 + random.Next(-5, 5)) / 100
                        };
                        indicators.Add(DH010106);

                        var DH01010702 = new Indicator
                        {
                            Code = "DH01010702",
                            value = DH01010205.value / (DH010104.value + DH010105.value) * 100
                        };
                        indicators.Add(DH01010702);

                        var DH01010704 = new Indicator
                        {
                            Code = "DH01010704",
                            value = DH01010102.value / DH010101.value * 100
                        };
                        indicators.Add(DH01010704);

                        var DH01010705 = new Indicator
                        {
                            Code = "DH01010705",
                            value = DH01010203.value / DH010102.value * 100
                        };
                        indicators.Add(DH01010705);

                        var DH0102 = new Indicator
                        {
                            Code = "DH0102",
                            value = 700 + random.Next(-100 , 200)
                        };
                        indicators.Add(DH0102);
                        ...
                        {
                            Code = "DH010201",
                            value = DH0102.value * (90 + random.Next(-2, 2)) / 100
                        };
                        indicators.Add(DH010201);
                        ...
                        {
                            Code = "DH01020201",
                            value = DH010202.value * (80 + random.Next(-1, 1)) / 100
                        };
                        indicators.Add(DH01020201);
                        ...
                        {
                            Code = "DH01020202",
                            value = DH010202.value - DH01020201.value
                        };
                        indicators.Add(DH01020202);
                        ...
                        {
                            Code = "DH030303",
                            value = DH010201.value * (95 + random.Next(-1, 1)) / 100
                        };
                        indicators.Add(DH010203);
                        ...
                        {
                            Code = "DH010204",
                            value = DH010203.value / DH010201.value * 100
                        };
                        indicators.Add(DH010204);
                        ...
                        {
                            Code = "DH010205",
                            value = DH0102.value * 60 / 100
                        };

                        var DH010206 = new Indicator
                        {
                            Code = "DH010206",
                            value = DH0102.value * 30 / 100
                        };
                        indicators.Add(DH010206);
                        #endregion
